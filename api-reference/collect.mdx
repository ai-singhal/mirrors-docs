---
title: "Collect agent traces API"
sidebarTitle: "Collect traces"
description: "POST /api/collect is the trace ingest endpoint the collectors speak: a project name and a batch of OpenAI-style message arrays, authenticated by workspace key."
icon: "inbox"
---
...
POST a JSON body with a `project` string and a `traces` array to
